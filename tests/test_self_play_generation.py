...
def test_modal_generation_defaults_to_one_l4_worker_with_four_cpus_and_eight_games() -> None:
    ...
    assert args.active_games_per_worker == GENERATION_1_ACTIVE_GAMES_PER_WORKER == 8
    assert SELF_PLAY_CPU == 4.0
    assert SELF_PLAY_MCTS_PROCESS_COUNT == 4
